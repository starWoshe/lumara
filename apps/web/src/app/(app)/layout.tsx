    ...
    <div className="min-h-screen lumara-gradient">
      ...
      <aside className="fixed left-0 top-0 h-full w-64 border-r border-white/5 bg-black/20 backdrop-blur-md z-40 hidden md:flex flex-col">
        ...
        <div className="p-4 border-t border-white/5">
          ...
          <Link href="/api/auth/signout" className="mt-2 w-full flex items-center gap-2 px-3 py-2 rounded-xl text-white/40 hover:text-white/70 hover:bg-white/5 transition-all text-xs">
            <span>↩</span> Вийти
          </Link>
        </div>
      </aside>
